...
import { BoostPackageBenefit } from './boost-package-benefit.entity';

@Entity('rillo_boost_packages')
export class BoostPackage {
  ...
  @ApiProperty({
    ...
    type: () => BoostPackageBenefit,
    isArray: true,
  })
  @OneToMany(() => BoostPackageBenefit, (benefit) => benefit.boost_package, {
    cascade: true,
  })
  benifits: BoostPackageBenefit[];
}
