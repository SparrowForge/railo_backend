...
export class PostVideoType1775114266181 implements MigrationInterface {
    name = 'PostVideoType1775114266181'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."rillo_posts_posttype_enum_old" AS ENUM('audio', 'location', 'poll', 'link', 'regular', 'camera', 'photo')`);
        await queryRunner.query(`ALTER TABLE "rillo_posts" ALTER COLUMN "postType" DROP DEFAULT`);
